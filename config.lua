-- The Forgotten Server Config
	...
	newPlayerSpawnPosX = 360
	newPlayerSpawnPosY = 275
	...
	maxPlayers = 175	
	motd = "Welcome to Collapser!\n(Patch 1.0)"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = false
	allowClones = false
	serverName = "Collapser"
	loginMessage = "Welcome to Collapser! Checkout our website, and stay up of the news. Don't forget: Follow the rules."
	...
	sqlPort = 3306
	sqlUser = "root"
	sqlPass = "9746698vitor"
	sqlDatabase = "collapser"
	...
	mapName = "zulu_v2.4.7-live.otbm"
	mapAuthor = "Vitor Subhi"
	randomizeTiles = true
	storeTrash = true
